...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Earthquake>> {
    ...
    private static final String USGS_REQ_URL = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&orderby=time&minmag=5&limit=10";
...
//                String url = "https://earthquake.usgs.gov/earthquakes/eventpage/us20004vvx";
...
//                startActivity(intent);
    ...
    public Loader<List<Earthquake>> onCreateLoader(int id, Bundle args) {
        return new EarthquakeLoader(this, USGS_REQ_URL);
    }
